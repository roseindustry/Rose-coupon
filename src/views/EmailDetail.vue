...
<template>
	...
	<div class="mailbox">
		...
		<div class="mailbox-toolbar">
			...
			<div class="mailbox-toolbar-item"><RouterLink to="/email/compose" class="mailbox-toolbar-link text-white bg-white bg-opacity-15">New Message <i class="fa fa-pen fs-12px ms-1"></i></RouterLink></div>
		</div>
		<!-- END mailbox-toolbar -->
		<!-- BEGIN mailbox-body -->
