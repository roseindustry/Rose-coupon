...
<template>
	...
	<card class="border-0 theme-gray-600 rounded-4 overflow-hidden" data-bs-theme="dark">
		<div class="row gx-0">
			...
			<card class="border-0 rounded-4 h-100">
				<card-body class="fs-14px p-30px d-flex flex-column">
					<div class="d-flex align-items-center">
						...
						<div>
							<Icon class="iconify display-4 text-gray-500 rounded-3" icon="solar:usb-bold-duotone" />
						</div>
					</div>
					<hr class="my-4" />
			...
			<card class="border-0 rounded-4 h-100">
				<card-body class="fs-14px p-30px d-flex flex-column">
					<div class="d-flex align-items-center">
						...
						<div>
							<Icon class="iconify display-4 text-gray-500 rounded-3" icon="solar:map-arrow-up-bold-duotone" />
						</div>
					</div>
					<hr class="my-4" />
					<div class="mb-5 text-body text-opacity-75 flex-1">
			...
			<card class="border-0 rounded-4 h-100">
				<card-body class="fs-14px p-30px d-flex flex-column">
					<div class="d-flex align-items-center">
						...
						<div>
							<Icon class="iconify display-4 text-gray-500 rounded-3" icon="solar:buildings-bold-duotone" />
						</div>
					</div>
					<hr class="my-4" />
					<div class="mb-5 text-body text-opacity-75 flex-1">
