<template>
	...
	<div class="mb-sm-4 mb-3 d-sm-flex">
		...
		<div class="ms-sm-4 mt-sm-0 mt-2">
			<a href="#" data-bs-toggle="dropdown" class="text-body text-decoration-none">More Actions <b class="caret ms-1"></b></a>
							...
							<tr>
								...
								<td>
									<div class="d-flex align-items-center">
										...
										<div class="ms-3">
											<RouterLink to="/page/product-details">Force Majeure White T Shirt</RouterLink>
										</div>
									</div>
								</td>
							...
							<tr>
								...
								<td>
									<div class="d-flex align-items-center">
										...
										<div class="ms-3">
											<RouterLink to="/page/product-details">Eco-friendly fashion, organic cotton, slow fashion polo shirts</RouterLink>
										</div>
									</div>
								</td>
							...
							<tr>
								...
								<td>
									<div class="d-flex align-items-center">
										...
										<div class="ms-3">
											<RouterLink to="/page/product-details">Nike Shoes (Red Color)</RouterLink>
										</div>
									</div>
								</td>
							...
							<tr>
								...
								<td>
									<div class="d-flex align-items-center">
										...
										<div class="ms-3">
											<RouterLink to="/page/product-details">Nike Air Max (Blue Color)</RouterLink>
										</div>
									</div>
								</td>
								<td class="align-middle">19 in stock for 1 variants</td>
							...
							<tr>
								...
								<td>
									<div class="d-flex align-items-center">
										...
										<div class="ms-3">
											<RouterLink to="/page/product-details">Skate Sneaker (Orange Color)</RouterLink>
										</div>
									</div>
								</td>
								<td class="align-middle">19 in stock for 1 variants</td>
							...
							<tr>
								...
								<td>
									<div class="d-flex align-items-center">
										...
										<div class="ms-3">
											<RouterLink to="/page/product-details">Teen Fashion T-shirt (Black)</RouterLink>
										</div>
									</div>
								</td>
							...
							<tr>
								...
								<td>
									<div class="d-flex align-items-center">
										...
										<div class="ms-3">
											<RouterLink to="/page/product-details">Levis Blue Jeans</RouterLink>
										</div>
									</div>
								</td>
							...
							<tr>
								...
								<td>
									<div class="d-flex align-items-center">
										...
										<div class="ms-3">
											<RouterLink to="/page/product-details">Boots (White Color)</RouterLink>
										</div>
									</div>
								</td>
								<td class="align-middle">19 in stock for 1 variants</td>
							...
							<tr>
								...
								<td>
									<div class="d-flex align-items-center">
										...
										<div class="ms-3">
											<RouterLink to="/page/product-details">Hiking Boots</RouterLink>
										</div>
									</div>
								</td>
							...
							<tr>
								...
								<td>
									<div class="d-flex align-items-center">
										...
										<div class="ms-3">
											<RouterLink to="/page/product-details">Dress (Pink)</RouterLink>
										</div>
									</div>
								</td>
