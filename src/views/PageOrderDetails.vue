<template>
	...
	<div class="mb-3 d-md-flex fw-bold">
		<div class="mt-md-0 mt-2"><a href="#" class="text-decoration-none text-body"><i class="bi bi-printer fa-fw me-1 text-body text-opacity-50"></i> Print</a></div>
		<div class="ms-md-4 mt-md-0 mt-2"><a href="#" class="text-decoration-none text-body"><i class="bi bi-boxes fa-fw me-1 text-body text-opacity-50"></i> Restock items</a></div>
		<div class="ms-md-4 mt-md-0 mt-2"><a href="#" class="text-decoration-none text-body"><i class="bi bi-pen fa-fw me-1 text-body text-opacity-50"></i> Edit</a></div>
		<div class="ms-md-4 mt-md-0 mt-2 dropdown-toggle">
			<a href="#" data-bs-toggle="dropdown" class="text-decoration-none text-body"><i class="bi bi-gear fa-fw me-1 text-body text-opacity-50"></i> More Actions</a>
	...
	<div class="row gx-4">
		<div class="col-lg-8">
			<card class="mb-4">
				<card-header class="d-flex align-items-center bg-inverse bg-opacity-10 fw-400">
					Products (3)
					<a href="#" class="ms-auto text-decoration-none text-body text-opacity-50"><i class="bi bi-truck fa-lg me-1"></i> Add Tracking Link</a>
				</card-header>
				<card-body class="text-body">
					<div class="row align-items-center">
						<div class="col-lg-8 d-flex align-items-center">
							...
							<div class="ps-3 flex-1">
								<div><a href="#" class="text-decoration-none text-body">iPhone 13 Pro Max</a></div>
					...
					<div class="row">
						<div class="col-lg-8 d-flex align-items-center">
							...
							<div class="ps-3 flex-1">
								<div class=""><a href="#" class="text-decoration-none text-body">Macbook Pro 2020</a></div>
								<div class="text-body text-opacity-50 small">
									SKU: MACBOOKPRO-1TB
								</div>
							</div>
					...
					<div class="row">
						<div class="col-lg-8 d-flex align-items-center">
							...
							<div class="ps-3 flex-1">
								<div class=""><a href="#" class="text-decoration-none text-body">Apple Watch 5</a></div>
								<div class="text-body text-opacity-50 small">
									SKU: APPLEWATCHBLACK
								</div>
							</div>
				...
				<card-footer class="bg-none d-flex p-3">
					<a href="#" class="btn btn-default ms-auto dropdown-toggle">More</a>
					<a href="#" class="btn btn-theme ms-2">Add Tracking</a>
				</card-footer>
			</card>
			<card>
				<card-header class="d-flex align-items-center bg-inverse bg-opacity-10 fw-400">
					Payment Records
					<a href="#" class="ms-auto text-decoration-none text-body text-opacity-50"><i class="bi bi-paypal me-1 fa-lg"></i> View paypal records</a>
				</card-header>
				<card-body>
		...
		<div class="col-lg-4">
			<card class="mb-4">
				<card-header class="d-flex align-items-center bg-inverse bg-opacity-10 fw-400">
					Notes
					<a href="#" class="ms-auto text-decoration-none text-body text-opacity-50">Edit</a>
				</card-header>
				<card-body>
