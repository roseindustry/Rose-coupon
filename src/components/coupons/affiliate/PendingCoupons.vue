    ...
    <div class="row g-4">
            ...
            <div class="coupon-card h-100">
                ...
                <div class="coupon-body">
                    ...
                    <div class="coupon-qr text-center mb-3">
                        <img :src="coupon.qrFileUrl" alt="logo" class="img-fluid">
                    </div>
                    <div class="coupon-details">
                        ...
                        <div class="coupon-info">
                            ...
                            <span class="coupon-value fw-bold text-success">${{ coupon.balance
                            }}</span>
                        </div>
                        <div class="coupon-info">
        ...
        <div class="col-12" v-else>
            <div class="empty-state-container text-center py-5">
                ...
                <p class="text-muted mb-4">Los cupones pendientes por pago aparecerán aquí cuando
                    estén
                    disponibles.</p>
